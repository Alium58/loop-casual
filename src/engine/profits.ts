...
export function printProfits(records: Records): void {
  ...
  printProfitSegment("* Farming", records["0@Farming"], "green");
  ...
  printProfitSegment("* Farming", records["1@Farming"], "green");
  ...
  printProfitSegment("* Farming", records["2@Farming"], "green");
  printProfitSegment("* Leveling", records["2@Leveling"], "green");
